...
const Item = ({
  ...
  return (
    <div className="border-b-1 text-black border-gray-500 bg-slate-50/30 backdrop-blur-md shadow-[#E1AFD1] shadow-2xl rounded-[30px]">
      <button
        type="button"
    ...
    <div className=" px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-12 ">
      <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 ">
          <h2 className="semibold z-30 relative max-w-lg mb-6 text-4xl  leading-none tracking-tight text-gray-900 sm:text-6xl md:mx-auto">
            Faq
          </h2>
